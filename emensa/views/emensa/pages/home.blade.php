...
@section('content')
    ...
    <section>
        <table class="flex-table">
            ...
            <tr>
                <td>{{ $gericht['name'] }} ><sub> <?php echo $gericht['allergene'] ?></sub></td>
                <td><?php echo showPrice($gericht['preis_intern']); ?></td>
                <td><?php echo showPrice($gericht['preis_extern']); ?></td>
            </tr>
            @endforeach
        </table>
    </section>
